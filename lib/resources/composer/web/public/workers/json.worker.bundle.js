...
exports.JSONDocument = exports.ValidationResult = exports.EnumMatch = exports.ObjectASTNodeImpl = exports.PropertyASTNodeImpl = exports.StringASTNodeImpl = exports.NumberASTNodeImpl = exports.ArrayASTNodeImpl = exports.BooleanASTNodeImpl = exports.NullASTNodeImpl = exports.ASTNodeImpl = exports.ProblemSeverity = exports.ErrorCode = undefined;
...
var _objects = __webpack_require__(105);

var objects = _interopRequireWildcard(_objects);

var _vscodeNls = __webpack_require__(42);
...
var _main2 = __webpack_require__(37);
...
var ProblemSeverity = exports.ProblemSeverity = undefined;
...
var EnumMatch = exports.EnumMatch = undefined;
(function (EnumMatch) {
...
function toProblemSeverity(diagnosticsSeverity) {
    switch (diagnosticsSeverity) {
        case _main2.DiagnosticSeverity.Error:
            return ProblemSeverity.Error;
        case _main2.DiagnosticSeverity.Warning:
            return ProblemSeverity.Warning;
        case _main2.DiagnosticSeverity.Information:
            return ProblemSeverity.Warning;
    }
                ...
                case 'uri-reference':
                    {
                        ...
                        if (!node.value) {
                            ...
                            try {
                                var uri = _index2.default.parse(node.value);
...
function parse(textDocument, config) {
    ...
    function _parseProperty(parent, keysSeen) {
        ...
        if (seen) {
            ...
            if ((typeof seen === 'undefined' ? 'undefined' : _typeof(seen)) === 'object') {
...
var _scanner = __webpack_require__(52);
...
var _scanner2 = __webpack_require__(52);
...
exports.JSONWorker = undefined;
exports.create = create;

var _jsonLanguageService = __webpack_require__(96);

var jsonService = _interopRequireWildcard(_jsonLanguageService);
...
exports.MarkedString = exports.FormattingOptions = exports.TextEdit = exports.Diagnostic = exports.SymbolInformation = exports.Range = exports.CompletionList = exports.CompletionItem = exports.Position = exports.TextDocument = undefined;
exports.getLanguageService = getLanguageService;

var _main = __webpack_require__(37);

var _jsonCompletion = __webpack_require__(98);

var _jsonHover = __webpack_require__(100);

var _jsonValidation = __webpack_require__(102);

var _jsonDocumentSymbols = __webpack_require__(99);

var _jsonParser = __webpack_require__(41);

var _configuration = __webpack_require__(97);

var _jsonSchemaService = __webpack_require__(101);

var _main2 = __webpack_require__(44);
...
function getLanguageService(params) {
    ...
    return {
        ...
        parseJSONDocument: function parseJSONDocument(document) {
            return (0, _jsonParser.parse)(document, { collectComments: true });
        },
...
var Parser = _interopRequireWildcard(_jsonParser);

var _main = __webpack_require__(44);

var Json = _interopRequireWildcard(_main);

var _json = __webpack_require__(104);

var _strings = __webpack_require__(53);
...
var JSONCompletion = /** @class */function () {
            ...
            if (node && node.type === 'object') {
                ...
                if (!schema && currentWord.length > 0 && document.getText().charAt(offset - currentWord.length - 1) !== '"') {
                    collector.add({
                        ...
                        insertTextFormat: _main2.InsertTextFormat.Snippet, documentation: ''
                    });
                }
            }
            ...
            if (s.node === node && !s.inverted) {
                ...
                if (schemaProperties_1) {
                    Object.keys(schemaProperties_1).forEach(function (key) {
                        ...
                        if ((typeof propertySchema === 'undefined' ? 'undefined' : _typeof(propertySchema)) === 'object' && !propertySchema.deprecationMessage && !propertySchema.doNotSuggest) {
                            var proposal = {
                                kind: _main2.CompletionItemKind.Property,
                                label: key,
    ...
    JSONCompletion.prototype.addDefaultValueCompletions = function (schema, separatorAfter, collector, arrayDepth) {
        ...
        if (!hasProposals && _typeof(schema.items) === 'object' && !Array.isArray(schema.items)) {
...
exports.JSONDocumentSymbols = undefined;
...
var JSONDocumentSymbols = /** @class */function () {
                        ...
                        for (var _i = 0, _a = item.properties; _i < _a.length; _i++) {
                            ...
                            if (property.keyNode.value === 'key') {
                                if (property.valueNode) {
                                    var location = _main.Location.create(document.uri, _main.Range.create(document.positionAt(item.offset), document.positionAt(item.offset + item.length)));
                                    result_1.push({ name: Parser.getNodeValue(property.valueNode), kind: _main.SymbolKind.Function, location: location });
                                }
                                return;
                            }
                        }
        ...
        var collectOutlineEntries = function collectOutlineEntries(result, node, containerName) {
            if (node.type === 'array') {
                ...
                node.properties.forEach(function (property) {
                    var location = _main.Location.create(document.uri, _main.Range.create(document.positionAt(property.offset), document.positionAt(property.offset + property.length)));
                ...
                for (var _i = 0, matchingSchemas_1 = matchingSchemas; _i < matchingSchemas_1.length; _i++) {
                    ...
                    if (!s.inverted && s.schema && (s.schema.format === 'color' || s.schema.format === 'color-hex') && s.node && s.node.type === 'string') {
                        ...
                        if (!visitedNode[nodeId]) {
                            ...
                            if (color) {
                                var range = _main.Range.create(document.positionAt(s.node.offset), document.positionAt(s.node.offset + s.node.length));
    ...
    JSONDocumentSymbols.prototype.getColorPresentations = function (document, doc, color, range) {
        ...
        result.push({ label: label, textEdit: _main.TextEdit.replace(range, JSON.stringify(label)) });
        return result;
    };
...
var JSONSchemaService = /** @class */function () {
    ...
    JSONSchemaService.prototype.getRegisteredSchemaIds = function (filter) {
        return Object.keys(this.registeredSchemasIds).filter(function (id) {
            var scheme = _index2.default.parse(id).scheme;
    ...
    JSONSchemaService.prototype.normalizeId = function (id) {
        ...
        return _index2.default.parse(id).toString();
    };
    ...
    JSONSchemaService.prototype.resolveSchemaContent = function (schemaToResolve, schemaURL) {
        ...
        var resolveExternalLink = function resolveExternalLink(node, uri, linkPath, parentSchemaURL) {
        ...
        var resolveRefs = function resolveRefs(node, parentSchema, parentSchemaURL) {
...
function toDisplayString(url) {
    try {
        var uri = _index2.default.parse(url);
        if (uri.scheme === 'file') {
            return uri.fsPath;
        }
    } catch (e) {
...
exports.JSONValidation = undefined;
...
var JSONValidation = /** @class */function () {
    ...
    JSONValidation.prototype.configure = function (raw) {
        if (raw) {
            ...
            this.commentSeverity = raw.allowComments ? _jsonParser.ProblemSeverity.Ignore : _jsonParser.ProblemSeverity.Error;
        }
    };
    JSONValidation.prototype.doValidation = function (textDocument, jsonDocument, documentSettings) {
        ...
        var addProblem = function addProblem(problem) {
            if (problem.severity === _jsonParser.ProblemSeverity.Ignore) {
                return;
            }
            ...
            if (!added[signature]) {
                ...
                var severity = problem.severity === _jsonParser.ProblemSeverity.Error ? _main.DiagnosticSeverity.Error : _main.DiagnosticSeverity.Warning;
                diagnostics.push({ severity: severity, range: range, message: problem.message });
            }
        };
        return this.jsonSchemaService.getSchemaForResource(textDocument.uri, jsonDocument).then(function (schema) {
            var trailingCommaSeverity = documentSettings ? documentSettings.trailingCommas : _jsonParser.ProblemSeverity.Error;
            ...
            if (schema) {
                if (schema.errors.length && jsonDocument.root) {
                    ...
                    if (property && property.keyNode.value === '$schema') {
                        ...
                        addProblem({ location: { offset: node.offset, length: node.length }, message: schema.errors[0], severity: _jsonParser.ProblemSeverity.Warning });
                    } else {
                        addProblem({ location: { offset: astRoot.offset, length: 1 }, message: schema.errors[0], severity: _jsonParser.ProblemSeverity.Warning });
                    }
                } else {
                ...
                if (schemaAllowsComments(schema.schema)) {
                    trailingCommaSeverity = commentSeverity = _jsonParser.ProblemSeverity.Ignore;
                }
            }
            jsonDocument.syntaxErrors.forEach(function (p) {
                if (p.code === _jsonParser.ErrorCode.TrailingComma) {
                    p.severity = trailingCommaSeverity;
                }
                addProblem(p);
            });
            diagnostics.push.apply(diagnostics, jsonDocument.externalDiagnostic);
            if (commentSeverity !== _jsonParser.ProblemSeverity.Ignore) {
...
function schemaAllowsComments(schemaRef) {
    if (schemaRef && (typeof schemaRef === 'undefined' ? 'undefined' : _typeof(schemaRef)) === 'object') {
...
var _jsonWorker = __webpack_require__(65);
